export default function Footer() {
  ...
  const quickLinks = ["About Us", "Gallery", "Book Now", "Contact", "Home"];
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-400 max-w-md leading-relaxed mb-4">
              Manchester's premium mobile barber service. We bring professional
              grooming directly to your doorstep with uncompromising quality and
              style.
            </p>
